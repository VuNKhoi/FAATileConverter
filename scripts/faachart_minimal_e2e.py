...
if __name__ == "__main__":
    ...
    if chart_type == 'sectional':
        ...
        if not url:
            ...
            sys.exit(1)
        # Try to extract date from filename (e.g., .../SEA_20250711.zip)
        import re
        ...
        if not entry:
            ...
            sys.exit(1)
        chart_date = entry.get('published_date')
        ...
        sys.exit(1)
    print(f"🎉 Download and extraction complete. Chart date: {chart_date}")
